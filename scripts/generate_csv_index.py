...
def main(argv: Optional[List[str]] = None) -> int:
    ...
    csv_path = args.csv
    if csv_path == DEFAULT_CSV and src_cfg and src_cfg.connector.config.get("path"):
        csv_path = src_cfg.connector.config["path"]
    ...
    if args.id_field == DEFAULT_ID_FIELD and src_cfg and src_cfg.id_field:
